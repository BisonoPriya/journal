...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" target="login.php" href="login.php">My Daily Journal</a>
        <button
        ...
        <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="admin.php?page=user">Profil <?= $_SESSION['username']?></a></li>
