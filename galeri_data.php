            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal" placeholder="Tuliskan Tanggal" value="<?= $row["tanggal"] ?>" >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        ?>
                        <input type="hidden" name="gambar_lama" value="<?= $row["gambar"] ?>"required>
                    </div>
                </div>
